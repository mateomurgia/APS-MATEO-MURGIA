...
ecg_filt_butt = signal.sosfilt(mi_sos_butter, ecg_one_lead)
ecg_filt_cauer = signal.sosfilt(mi_sos_cauer, ecg_one_lead)
ecg_filt_cheb1 = signal.sosfilt(mi_sos_cheby1, ecg_one_lead)
ecg_filt_cheb2 = signal.sosfilt(mi_sos_cheby2, ecg_one_lead)
ecg_filt_butt_fase0 = signal.sosfiltfilt(mi_sos_butter, ecg_one_lead)
plt.figure()

plt.plot(ecg_one_lead[:50000], label = 'ecg raw')
#plt.plot(ecg_filt_butt[:50000], label = 'butter')
#plt.plot(ecg_filt_cauer[:50000], label = 'cauer')
#plt.plot(ecg_filt_cheb1[:50000], label = 'cheby1')
